      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form method= "post" class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="address" class="form-label">CS3301 Data Structures</label>
              <select name = "ds" class="form-select" id="country" required>
                <option value="">Choose...</option>
                <option>O</option>
                <option>A+</option>
                <option>A</option>
            ...
            <div class="col-12">
              <label for="email" class="form-label">CS3311 Data Structures Laboratory</label> 
              <select name = "ds_lab" class="form-select" id="country" required>
                <option value="">Choose...</option>
                <option>O</option>
                <option>A+</option>
                <option>A</option>
...
<tr>
  <td>CS3311 Data Structures Laboratory</td>
  <td><?echo $grade_ds_lab?></td>
  <td><?echo $ds_lab?></td>
</tr>
<tr>
...
<?
$result =(($dpco*4) + ($maths*4) + ($ds*3) + ($oops*3) + ($fds*3) +
($ds_lab*1.5) + ($oops_lab*1.5) + ($fds_lab*2) )/22;
